    ...
    return(
      <div className='col col-md-8'>      
        <div className='panel panel-default'>
          ...
          <span role='button' onClick={this.handleDelete} className='glyphicon glyphicon-trash danger pull-right delete-todo' style={{color: "DarkRed", margin:'5px 0px'}}></span>
          <span role='button' onClick={this.handleDelete} className='glyphicon glyphicon-edit pull-right edit-todo' style={{color: "DarkCyan",margin:'5px 15px'}}></span>                      
        </a>
        ...
        <a className="list-group-item list-group-item-danger">
          ...
          <div role='button' onClick={this.handleDelete} className='glyphicon glyphicon-trash danger pull-right delete-todo' style={{color: "DarkRed", margin:'5px 0px'}}></div> 
          <div role='button' onClick={this.handleDelete} className='glyphicon glyphicon-edit pull-right edit-todo' style={{color: "DarkCyan",margin:'5px 15px'}}></div>
        </a>
        ...
        <a className="list-group-item list-group-item-success">
          ...
          <div role='button' onClick={this.handleDelete} className='glyphicon glyphicon-trash danger pull-right m-3 delete-todo' style={{color: "DarkRed", margin:'5px 0px'}}></div>
          <div role='button' onClick={this.handleDelete} className='glyphicon glyphicon-edit pull-right edit-todo' style={{color: "DarkCyan",margin:'5px 15px'}}></div>
        </a>
